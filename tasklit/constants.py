...
class SuccessErrorCodes:
    ...
    SCHEDULER_FAILURE = 2147750687 # (0x8004131F) The task scheduler service is not available.
    DEVICE_FAILURE = 2147943645 # (0x80070015) The device is not ready.
    SYSTEM_FAILURE = 2147942402 # (0x80070002) The system cannot find the file specified.
